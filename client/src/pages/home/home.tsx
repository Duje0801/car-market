  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex px-4 lg:w-2/3 lg:pl-16 lg:pr-6 xxl:px-16">
          <SearchAds setError={setError} />
        </div>
        {/*Boxes - middle/right*/}
        <div className="flex flex-col mt-6 gap-6 lg:mt-0 lg:px-4 lg:w-1/3 lg:pr-16 lg:pl-6 xxl:px-16">
          <Box1 />
          <Box2 />
        </div>
      </div>
      {/*5 newest ads*/}
      <div className="mx-auto w-[90vw] md:w-[70vw] lg:w-full lg:px-16">
        <NewestAds />
      </div>
    </div>
  );

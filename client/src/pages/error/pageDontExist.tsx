...
export function PageDontExist() {
  ...
  return (
    <div className="flex flex-col gap-4 mt-8">
      <h2 className="text-2xl text-center w-[65vw] mx-auto xxl:text-3xl">
      ...
      <figure>
        ...
        <button onClick={handleClick} className="btn bg-black text-white w-[40vw] mx-auto md:w-[30vw] lg:w-[20vw] xxl:text-3xl">Go to home page</button>
    </div>
  );
}
